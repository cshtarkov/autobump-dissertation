...
that JDiff knows what to compare. Alternatively, it can be run twice
manually with the two versions to compare checked out one after
the other.
...
about loss of backward compatibility. It was used in study of the
Maven repository \cite{SemverMaven} to determine compatibility between
different versions of published Jar files.
...
% TODO: Do Clirr and JDiff care about subclasses and stuff?
