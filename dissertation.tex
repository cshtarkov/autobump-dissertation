...
This requires little to no manual intervention from the user, no
special naming schemes, and is as reliable as this kind of software
can be.
...
separate module, with dependencies (via \pythoninline{import}) reduced
to a minimum.
