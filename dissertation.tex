...
\subsubsection{japicmp}

compatibility between provided Jar files, which are bundles of
compiled Java code. It can tie into the build system Maven and
...
fine, because of Java's inheritance rules.
