...
% Comment that the changes have been the same
...
enough to warrant evaluation. This made the library itself the only
candidate to evaluate whether static types in an otherwise dynamic
...
All versions & 0 \\
Mismatches & 0 \\
Mismatches (breaking) & 0 \\
Proportion of mismatches & 0\% \\
Proportion of mismatches (breaking) & 0\% \\
\end{tabular}
\end{wraptable}
