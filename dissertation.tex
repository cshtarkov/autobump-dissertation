...
\begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth,height=0.25\textheight]
...
consumption by customers. One possible solution to this problem would
...
\subsection{Language handler for binary files}
...
\subsection{A better automated versioning scheme}
...
information can be encoded into the version number.
