...
\centering
\includegraphics[height=0.3\textheight]{images/dot/architecture}
...
all visible entities form the public API. The reason for that is that
...
used for more general concepts. For example, Clojure records
(described in appendix \ref{ClojurePrimer}) are intuitively
seen as \pythoninline{Unit}s because they indicate a grouping of
entities. However, Clojure is a functional programming language and
they are internally represented with functions. In this
case CAPIR follows the language's representation and treats those as
\pythoninline{Function}s as well.
% TODO: clojre records are not described
...
\begin{figure}[H]
\centering
\includegraphics[height=0.3\textheight]{images/dot/repr}
...
representation is semantically indentical to CAPIR. The
...
(as do other similar build systems) is starting a REPL and then
...
% TODO: return things like --silence, --debug if there is enough space
...
over time can be shown. Appendix \ref{Listings} shows the
...
% TODO: write this
% TODO: were the assumptions reasonable?
...
% TODO: what about all mismatches, not just breaking?

% TODO: how much of a problem mismatches are
...
% TODO: integration with dev tools

% TODO: evaluation: does LOC impact adherence?
