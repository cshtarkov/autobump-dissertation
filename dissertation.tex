...
necessitates either changing the label or dropping it, i.e.
...
itself via reflection (elm-package and Java-specific tools).
...
Reflection is a more robust approach, but still has its
...
compatibility:
\begin{equation}
\forall(T_a,T_b) \in S, \mathrm{compatible}(T_a,T_b) \in
