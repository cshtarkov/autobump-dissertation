...
* Started evaluation <2017-01-31 Tue>
  ...
  - evaluated 4 python libraries + 2 java libraries ([[file:~/Source/autobump-dissertation/resources/projects_for_evaluation.org][notes]] [[https://github.com/cshtarkov/autobump-dissertation/blob/master/resources/projects_for_evaluation.org][githubnotes]])

  Python is more prone to breaking changes than Java
  ...
  *Summary / Thesis*:
  ...
  5. Doesn't seem to be any relation between projects that outright say "we follow Semver" and ones
